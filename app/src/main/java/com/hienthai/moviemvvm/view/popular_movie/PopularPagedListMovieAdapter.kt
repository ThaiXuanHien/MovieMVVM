...
import com.hienthai.moviemvvm.view.single_movie_details.MovieDetailActivity
import kotlinx.android.synthetic.main.item_movie_popular.view.*
import kotlinx.android.synthetic.main.item_network_state.view.*

class PopularPagedListMovieAdapter(public val context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        if (viewType == MOVIE_VIEW_TYPE) {
            view = layoutInflater.inflate(R.layout.item_movie_popular, parent, false)
    ...
    class MovieItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(movie: Movie?, context: Context) {
            ...
            itemView.txt_movie_release_date_popular.text = movie?.releaseDate
    ...
    class NetworkStateItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(networkState: NetworkState?) {
            ...
            if (networkState != null && networkState == NetworkState.ERROR) {
                itemView.txt_error_msg_item.visibility = View.VISIBLE
                itemView.txt_error_msg_item.text = networkState.msg
            } else if (networkState != null && networkState == NetworkState.END_OF_LIST) {
                itemView.txt_error_msg_item.visibility = View.VISIBLE
                itemView.txt_error_msg_item.text = networkState.msg
            } else {
                itemView.txt_error_msg_item.visibility = View.GONE
            }
        }
    }
